  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className={`flex items-center justify-between px-4 md:px-8 w-full h-[80px] top-0 bg-white/80 md:dark:border-none  dark:bg-black/80 dark:border-b-gray-800 z-20 fixed backdrop-blur-md ${
          scrollY > 150 ? "shadow-sm border-b" : ""
        }`}
